...
def single_simulation(data, lam, T, R):
    ...
    # Return the 95% CI range of values
...
print(combined_simulation(df_incomes, df_example_food20, lam_combined, T, 1000, p_income))
...
print(combined_simulation(df_example_salary, df_expenses, lam_combined_ex2, T, 1000, p_income))
